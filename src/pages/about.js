    ...
    <Layout>
      ...
      <div style={{maxWidth:900}}>
        <div>
          ...
          <p>Build In SE: At Build In SE, our mission is to increase the number of startup success stories in the Southeast by leveraging a cross-regional, collaborative network of entrepreneurs, ecosystem builders, and investors. We believe in the power of community to support founders as they launch and scale their businesses.</p>
